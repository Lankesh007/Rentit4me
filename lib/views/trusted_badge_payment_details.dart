...
class TrustedBadgePaymentDetails extends StatefulWidget {
  const TrustedBadgePaymentDetails({Key key}) : super(key: key);

  @override
  State<TrustedBadgePaymentDetails> createState() =>
      _TrustedBadgePaymentDetailsState();
}

class _TrustedBadgePaymentDetailsState
    extends State<TrustedBadgePaymentDetails> {
  bool _loading = false;
  String package_id;
  String package_name;
  String plan_id;
    ...
    try {
      var options = {
        ...
        'amount': couponApplied == true
            ...
            : (double.parse(tBAmount.toString()) * 100),
        'description': '',
  ...
  Future applyCouponDetails() async {
    ...
    var body = {
      ...
      "type": "trusted-badge".toString(),
      "sub_total": tBAmount.toString(),
    };
  ...
  String tBName;
  int tBAmount;
  Future getTrustedBadgeDetails() async {
